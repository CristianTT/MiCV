...
public class NewConocimientoController extends Dialog<Conocimiento> implements Initializable {
	...
	public NewConocimientoController() {
		super();
		setTitle("MiCV");
		getDialogPane().getButtonTypes().addAll(AGREGAR_BUTTON_TYPE, ButtonType.CANCEL);
		getDialogPane().setContent(loadContent("/fxml/NewConocimientoDialog.fxml"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		conocimiento.denominacionProperty().bindBidirectional(denominacionText.textProperty());
